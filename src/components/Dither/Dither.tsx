...
// Custom Error boundary to wrap the canvas
...
class ErrorBoundary extends Component {
  ...
  componentDidCatch(error) { console.warn('Dither Canvas crashed:', error); }
  render() {
    if (this.state.hasError) return <div style={{width: '100%', height: '100%', background: '#FFEDED'}} />;
